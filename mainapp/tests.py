...
class TestCoursesWithMock(TestCase):
    fixtures = (
        ...
        "mainapp/fixtures/003_lesson.json",
        "mainapp/fixtures/004_teacher.json",
    )
...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.selenium.find_elements(By.ID, "username").send_keys("admin")
        self.selenium.find_elements(By.ID, "password").send_keys("admin")
        button_enter.click()
        # Wait for footer
